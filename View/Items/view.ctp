    ...
    <a class="navbar-brand"><?php echo __('Acões'); ?></a>
        <?php if (isset($usuario)): ?>
            ...
            <?php elseif ($usuario['role'] == 'editor' || $usuario['role'] == 'admin'): ?>
                <li class="nav-item"><?php echo $this->Html->link(__('Novo Item'), array('action' => 'add'), ['class' => "nav-link"]); ?> </li>
                <li class="nav-item"><?php echo $this->Html->link(__('Editar Item'), array('action' => 'edit', $item['Item']['id']), ['class' => "nav-link"]); ?> </li>
                ...
                <li class="nav-item"><?php echo $this->Html->link(__('Listar Items'), array('action' => 'index'), ['class' => "nav-link"]); ?> </li>
            <?php endif; ?>
        <?php endif; ?>
    </ul>
</nav>
...
<dl class="row">
    ...
    <dd class="col-sm-9"><?php echo substr($item['Item']['item'], 0, 2); ?></dd>
