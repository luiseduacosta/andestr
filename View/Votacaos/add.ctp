...
<fieldset>    
    ...
    if (isset($item)):
        echo $this->Form->input('tr', array('label' => 'TR (digite dois carateres numéricos)', 'value' => substr($item['Item']['item'], 0, 2)));
    elseif (isset($tr)):
        echo $this->Form->input('tr', array('label' => 'TR (digite dois carateres numéricos)', 'value' => $tr));
    else:
        echo $this->Form->input('tr', array('label' => 'TR (digite dois carateres numéricos)'));
    endif;
    ...
    elseif (isset($tr)):
        ...
        echo $this->Form->input('item', array('label' => 'Item. Formato nn.nn. Digitar: número da TR "." e o número do item. Digite "99" como número do item para indicar inclusão de novo item.'));
    endif;
    ...
    <legend><?php echo 'Aprovação da TR na sua totalidade'; ?></legend>
