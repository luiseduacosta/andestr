        ...
        <div id="container">
            <div id="header">
                ...
                <p>
                    ...
                    <?php echo $this->Html->link('Textos de apoio', '/Apoios/index'); ?>
                    <?php echo $this->Html->link('TRs', '/Items/index'); ?>
                    <?php
                    if (isset($usuario)):
                    ...
                    ?>
                    <?php echo $this->Html->link('Relatórios', '/Votacaos/relatorio'); ?>
                    <?php echo $this->Html->link('Sair', '/Users/logout'); ?>
                    <?php echo "<br>"; ?>
                    <?php
                    if (isset($usuario)):
                        if ($usuario['papel'] === 'relator'):
                            echo $this->Html->link("Grupo: " . $usuario['grupo'], '/Votacaos/index/grupo:' . $usuario['grupo']);
